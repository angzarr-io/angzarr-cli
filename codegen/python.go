...
func (pyEmitter) Suffix() string         { return "_angzarr.py" }
func (pyEmitter) ScaffoldSuffix() string { return "_angzarr_handler.py" }
...
func (e pyEmitter) EmitFile(g *protogen.GeneratedFile, file *protogen.File, services []*Service) error {
	refs := newPyRefs(services)
...
func (e pyEmitter) EmitScaffold(g *protogen.GeneratedFile, file *protogen.File, services []*Service) error {
	refs := newPyRefs(services)
