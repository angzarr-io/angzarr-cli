...
func (goEmitter) ScaffoldSuffix() string { return "_angzarr_handler.go" }
...
// EmitScaffold writes the generate-once handler stub file: a struct per
// component implementing its Handler interface, each method wrapped in
// angzarr:scaffold markers with a TODO body.
func (e goEmitter) EmitScaffold(g *protogen.GeneratedFile, file *protogen.File, services []*Service) error {
